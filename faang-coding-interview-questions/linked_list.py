...
class LinkedList:
  ...
  def find_nth_element(self, kth: int) -> Node:   
    if not self.head or kth < 1:
      return -1
    
    current = self.head
    iteration = 1
    
    while current.next and iteration + 1 <= kth:
      current = current.next
      iteration += 1
...
# Find nth element
# print(linked_list.find_nth_element(5))
# print(linked_list.find_nth_element(1))
# print(linked_list.find_nth_element(3))
